...
cargo run --manifest-path /home/moritz/Documents/dioxus/packages/cli/Cargo.toml serve --web --verbose --base-path public --release # --hot-patch not allowed in release mode
